# /flaskr/forms.py: contains code for the file upload form
...
class UploadForm(FlaskForm):
    ...
    n_neighbors = SelectField(
        label='Please select the number of neighbors the classifier should use for classification: ',
